...
function get3Words(roomID) {
    ...
    // لێرەدا کێشەی پیتی بچووک چارەسەر کراوە و زمانەکە ڕاستەوخۆ بە کوردی دەخوێنرێتەوە
    const language = "kurdish"; 
    if (!words[language] || games[roomID].customWords.length < 3) {
        return chance.pickset(words[language] || words["english"] || [], 3);
    }
